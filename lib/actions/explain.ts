 ...
 * duplicated deliberately (pipeline-internal values aren't exported) rather
 * than importing non-exported pipeline internals.
 */
 ...
 * features.ts's avgChurnForCluster but mode-agnostic — re-derived here at read
 * time so the justification stays accurate regardless of pipeline mode.
 */
